  ...
  anime.searchAnime(pixelien).then(res => {
    ...
    let codework = new Discord.MessageEmbed()
      ...
      .setDescription(
        `:star: ${
          res[0].averageRating
        }\n\n**MyAnimeList kullanıcı sayısı** : \`${
          res[0].userCount
        }\`\n**MyAnimeList favori sayısı** : \`${
          res[0].favoritesCount
...
//Duyur AnimeAra komutu V12
//hayiryav İzinsiz paylaşmayınız
//jssi Gereken modüller : @freezegold/anime.js
